	...
	const string SystemServices::FRIENDLY_ID = "friendly_id";
        ...
        void SystemServices::DeinitializeIARM()
        {
            if (Utils::IARM::isConnected())
            {
                ...
                IARM_CHECK( IARM_Bus_UnRegisterEventHandler(IARM_BUS_PWRMGR_NAME, IARM_BUS_PWRMGR_EVENT_REBOOTING));
                IARM_CHECK( IARM_Bus_UnRegisterEventHandler(IARM_BUS_PWRMGR_NAME, IARM_BUS_PWRMGR_EVENT_NETWORK_STANDBYMODECHANGED));
    #ifdef ENABLE_THERMAL_PROTECTION
